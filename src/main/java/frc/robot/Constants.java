...
public class Constants {
    ...
    public static final PresetPosition armHigh = PresetPosition.fromGoal(new Translation2d(armHighX, armHighY), wristHighAngle);
    ...
    public static final PresetPosition armMid = PresetPosition.fromGoal(new Translation2d(armMidX, armMidY), wristMidAngle);
