...
public class Constants {
    ...
    public static final double armHighX = 40.5; // 40.875
    public static final double armHighY = 8.58;
    public static final double wristHighAngle = 351;
    public static final PresetPosition armHigh = PresetPosition.fromGoal(new Translation2d(armHighX, armHighY), wristHighAngle, true);
    public static final double armMidX = 40.5; // 31.7, -9.4, 349.7
    public static final double armMidY = 3;
    public static final double wristMidAngle = 304;
    public static final PresetPosition armMid = PresetPosition.fromGoal(new Translation2d(armMidX, armMidY), wristMidAngle, true);
    public static final double armInvertedGrabX = 1.574;
    public static final double armInvertedGrabY = -27.0;
    public static final double wristInvertedAngle = 298;
    public static final PresetPosition armInvertedGrab = PresetPosition.fromGoal(new Translation2d(armInvertedGrabX, armInvertedGrabY), wristInvertedAngle, false);
    ...
    public static final PresetPosition armNormalGrab = PresetPosition.fromGoal(new Translation2d(armGroundX, armGroundY), wristGroundAngle, false);
    public static final double armStowX = 0.26;
    public static final double armStowY = -24.5;
    public static final double wristStowAngle = 305.21;
    public static final PresetPosition armStow = PresetPosition.fromGoal(new Translation2d(armStowX, armStowY), wristStowAngle, false);
