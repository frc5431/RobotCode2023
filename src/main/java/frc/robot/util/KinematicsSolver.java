...
public class KinematicsSolver {
    public static boolean PREFER_BOTTOM_POSSIBILITY = true;
    public static boolean PREFER_ABOVE_POSSIBILITY = false;


    private double l1; // Length of first arm segment
    private double l2; // Length of second arm segment
    public boolean SuperpositionCollapsePreferance = PREFER_BOTTOM_POSSIBILITY;
    ...
    private double solveSegment2Angle(Translation2d goal) {
        ...
        return (SuperpositionCollapsePreferance == PREFER_ABOVE_POSSIBILITY ? -1 : 1) * Math.acos(p1/p2);
    }
    ...
    private double solveSegment1Angle(double q2, Translation2d goal) {
        ...
        return (SuperpositionCollapsePreferance == PREFER_ABOVE_POSSIBILITY ? p1 + p2 : p1 - p2);
    }

    public Pair<Double, Double> posToAngles(Translation2d goal) {
        double q2 = solveSegment2Angle(goal);
