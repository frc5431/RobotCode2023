...
//         eventMap.put("stowCubePlace", stowCubePlacement());
//         eventMap.put("placeHighAdjacentCone", placeHighNoDrive(GamePiece.CONE));
//         eventMap.put("placeHighAdjacentCube", placeHighNoDriveCube(GamePiece.CUBE));
...
//     public Command placeHighNoDriveCube(GamePiece holding) {
//         return sequence(
//             new ArmToGoalCommand(
//                 systems,
//                 Constants.armHighIntermediateOld,
...
//     public Command stowCubePlacement() {
//         return sequence(
//             new ArmToGoalCommand(
//                 systems,
//                 Constants.armStow,
